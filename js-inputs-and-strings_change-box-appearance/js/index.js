...
const sliderColor = document.querySelector(
    '[data-js=input-color]',
  );

const sliderRadius = document.querySelector(
    '[data-js=input-radius]',
  );

const sliderRotation = document.querySelector(
    '[data-js=input-rotation]',
  );

  const inBoxYolo = document.querySelector(
    '[data-js=box]',
  );


  sliderColor.addEventListener('slide', () => { inBoxYolo.style.backgroundColor = 
    
  });


  sliderRadius.addEventListener('click', () => {
    
  });

  sliderRotation.addEventListener('click', () => {
